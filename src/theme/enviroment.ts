export const enviroment = {
    ...
    programacao_qua_url: '/wp-json/wp/v2/prog-qua?per_page=30',
    programacao_qui_url: '/wp-json/wp/v2/prog-qui?per_page=30',
    programacao_sex_url: '/wp-json/wp/v2/prog-sex?per_page=30',
    programacao_sab_url: '/wp-json/wp/v2/prog-sab?per_page=30',
}